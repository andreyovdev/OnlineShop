$(document).ready(function () {
    ...
    function isProductInWishlist(productId) {
        ...
        $.ajax({
            url: `/Shop/IsProductInWishlist?productId=${productId}`,
            type: 'GET',
            async: false,
    ...
    function setupWishlistButtons() {
        $('.wishlist-btn').on('click', function () {
            ...
            const wishlistSvg = buttonElement.find('.wishlist-svg');
            ...
            $.ajax({
                url: isProductInWishlist(productId) ? '/Shop/RemoveFromWishlist' : '/Shop/AddToWishlist',
                type: 'POST',
                contentType: 'application/json',
